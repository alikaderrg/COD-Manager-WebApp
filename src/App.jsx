...
export default function App() {
  ...
  */
  ...
  // IMPORTANT: Fixed layout approach - no dynamic margin calculations
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {!isAuthPage && !isSettingsPage && activeSection && (
        <div className="fixed left-16 top-0 h-full z-10">
          <SubSidebar
      ...
      {/* Main content with fixed padding instead of dynamic margin */}
